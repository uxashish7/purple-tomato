...
class UpstoxService {
  ...
  List<Stock> _getAllSearchableStocks() {
    return [
      Stock(instrumentKey: 'NSE_EQ|INE758T01015', symbol: 'ETERNAL', name: 'Eternal Limited (formerly Zomato)', exchange: 'NSE'),
      Stock(instrumentKey: 'NSE_EQ|INE758T01015', symbol: 'ZOMATO', name: 'Eternal Ltd / Zomato', exchange: 'NSE'),
      Stock(instrumentKey: 'NSE_EQ|INE02GU01015', symbol: 'SWIGGY', name: 'Swiggy Limited', exchange: 'NSE'),
      ...
      Stock(instrumentKey: 'NSE_EQ|INE165Q01014', symbol: 'NYKAA', name: 'FSN E-Commerce (Nykaa)', exchange: 'NSE'),
  ...
  // _getMockSearchResults removed — was dead code (never called).
  // searchStocks() uses _getAllSearchableStocks() directly.

  Map<String, MarketQuote> _getMockQuotes(List<String> instrumentKeys) {
    final mockPrices = {
      // Correct ISINs as of 2025 (Eternal = Zomato rebrand)
      'NSE_EQ|INE758T01015': 318.70,   // ETERNAL (Zomato)
      'NSE_EQ|INE02GU01015': 390.00,   // SWIGGY
      'NSE_EQ|INE165Q01014': 155.00,   // NYKAA
